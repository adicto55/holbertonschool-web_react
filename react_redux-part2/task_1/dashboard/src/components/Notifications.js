...
// Pass `loading` down as a prop
const Notifications = ({ notifications = [], loading = false, markNotificationAsRead }) => {
  ...
  return (
    <>
      ...
      <div className={css(styles.notificationsContainer)} ref={DrawerRef}>
        ...
        {/* 3. Conditionally render the UI based on the loading state */}
        {loading ? (
          <p>Loading...</p>
        ) : (
          <>
